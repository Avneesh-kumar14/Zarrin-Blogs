        ...
        {loading ? (
          <div className="text-center py-12">
            <div className="inline-block">
              ...
              <Paragraph className="mt-4 text-gray-600">Loading bookmarks...</Paragraph>
            </div>
          </div>
        ) : bookmarks.length > 0 ? (
          <>
            <Paragraph className="text-gray-600 mb-8 font-semibold">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2 rounded-lg hover:shadow-md transition-all font-semibold"
                      >
                        Read
                        <ArrowRight size={16} />
                      </button>
                      <button
                        ...
                        className="px-3 py-2 bg-red-100 hover:bg-red-200 text-red-600 rounded-lg transition-colors disabled:opacity-50"
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <Heading type="h3" className="text-2xl font-semibold text-gray-700 mb-2">
              No bookmarks yet
            </Heading>
