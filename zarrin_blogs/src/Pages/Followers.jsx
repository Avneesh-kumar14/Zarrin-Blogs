    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Paragraph className="text-gray-600 text-lg">Loading followers...</Paragraph>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <Paragraph className="text-blue-50 text-lg mt-2">
                {userName && `People following ${userName}`}
              </Paragraph>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {followers.map((follower) => (
              ...
              >
                ...
                {/* Content */}
                <div className="p-6">
                  <Heading type="h3" className="text-xl font-bold text-gray-900 mb-1 text-center group-hover:text-blue-600 transition-colors">
                    {follower.name}
                  </Heading>
                  ...
                  <div className="flex gap-4 mb-6 justify-center py-4 border-y border-gray-200">
                    <div className="text-center">
                      <Heading type="h4" className="text-xl font-bold text-blue-600">
