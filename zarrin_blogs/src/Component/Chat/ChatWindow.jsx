...
const ChatWindow = ({ conversation }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-surface-primary dark:bg-surface-dark">
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-2 bg-surface-primary dark:bg-surface-dark">
        <MessageList 
          messages={messages}
        ...
        {/* Typing Indicator */}
        {typingUsers.size > 0 && (
          <div className="flex items-center gap-2 mt-4 p-3 bg-neutral-100 dark:bg-neutral-800 rounded-full w-fit text-xs text-text-secondary">
            <span>
            ...
            <div className="flex gap-1">
              ...
              <span className="w-2 h-2 bg-text-secondary rounded-full animate-pulse" style={{ animationDelay: '0.2s' }}></span>
              <span className="w-2 h-2 bg-text-secondary rounded-full animate-pulse" style={{ animationDelay: '0.4s' }}></span>
            </div>
          </div>
        )}
